...
action = function(host, port)
 ...
 local url = stdnse.get_script_args(SCRIPT_NAME..".url") or "/logon/LogonPoint/receiver/images/common/icon_vpn.ico"
 local response = http.generic_request(host, port, "GET", "/logon/LogonPoint/receiver/images/common/icon_vpn.ico", options)
